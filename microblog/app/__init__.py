...
# Error logging utilities. only run when not in debug modes
if not app.debug:
    # Enables emailing erro logs, requires that the email server details be seperately provided
    ...
    # Enables error logging to a log file
